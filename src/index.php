...
<html class="no-js"> <!--<![endif]-->
  ...
  <body>
    ...
    <a class="githubForkMeBagde" href="https://github.com/mablae/diaspora-reshare-visualization">
    ...
    <div id="topNav" style="padding-left: 0px; padding-right: 0px;">
      <div class="container" style="margin-left: 25px;">
        <div class="row">
          <div class="span5">
            Diaspora ReShare Graph <a title="Clear the form." href="http://rsv.spyurk.am"><strong>rsv.spyurk.am</strong></a>
            <p>
              A D3.js powered grafter to follow reshares.<br>
              <strong>Bookmarklet</strong>: 
              <a title="Drop this bookmarklet on your bookmark bar and click it when in the single post view." href="javascript:window.location.href%20=%20'http://rsv.spyurk.am/?startUrl='+encodeURIComponent(window.location.href);void%200;">Diaspora ReShare Graph</a><br>
          ...
          <div class="span7">
            <form style="margin-bottom: 5px;" class="form-horizontal" id="searchForm">
              ...
              <button type="submit" class="btn" onclick="javascript:window.location.href = 'http://rsv.spyurk.am/?startUrl='+window.searchForm.startUrl.value; window.searchForm.startUrl.value=''">Start</button>
            </form>
            <script type="text/javascript">
              document.write( '<a title="Copy and paste this link to share your rsv." href=http://rsv.spyurk.am/?' + window.searchForm.startUrl.value + '>http://rsv.spyrk.am/?' + window.searchForm.startUrl.value + '<\/a>' );
            </script>
            <div id="loader">
